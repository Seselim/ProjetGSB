...
('a131', 'Villechalane', 'Louis', 'lvillachane', 'jux7g', '8 rue des Charmes', '46000', 'Cahors', '2011-12-21'),
('a17', 'Andre', 'David', 'dandre', 'oppg5', '1 rue Petit', '46200', 'Lalbenque', '2020-11-23'),
('a55', 'Bedos', 'Christian', 'cbedos', 'gmhxd', '1 rue Peranud', '46250', 'Montcuq', '2021-01-12'),
('a93', 'Tusseau', 'Louis', 'ltusseau', 'ktp3s', '22 rue des Ternes', '46123', 'Gramat', '2006-05-01'),
('b13', 'Bentot', 'Pascal', 'pbentot', 'doyw1', '11 allée des Cerises', '46512', 'Bessines', '2022-07-09'),
('b16', 'Bioret', 'Luc', 'lbioret', 'hrjfs', '1 Avenue gambetta', '46000', 'Cahors', '2006-05-11'),
('b19', 'Bunisset', 'Francis', 'fbunisset', '4vbnd', '10 rue des Perles', '93100', 'Montreuil', '2023-10-21'),
('b25', 'Bunisset', 'Denise', 'dbunisset', 's1y1r', '23 rue Manin', '75019', 'paris', '2018-12-05'),
('b28', 'Cacheux', 'Bernard', 'bcacheux', 'uf7r3', '114 rue Blanche', '75017', 'Paris', '2017-11-12'),
('b34', 'Cadic', 'Eric', 'ecadic', '6u8dc', '123 avenue de la République', '75011', 'Paris', '2022-09-23'),
('b4', 'Charoze', 'Catherine', 'ccharoze', 'u817o', '100 rue Petit', '75019', 'Paris', '2013-12-13'),
('b50', 'Clepkens', 'Christophe', 'cclepkens', 'bw1us', '12 allée des Anges', '93230', 'Romainville', '2019-08-11'),
('b59', 'Cottin', 'Vincenne', 'vcottin', '2hoh9', '36 rue Des Roches', '93100', 'Monteuil', '2007-11-18'),
('c14', 'Daburon', 'François', 'fdaburon', '7oqpv', '13 rue de Chanzy', '94000', 'Créteil', '2008-02-11'),
('c3', 'De', 'Philippe', 'pde', 'gk9kx', '13 rue Barthes', '94000', 'Créteil', '2016-12-14'),
('c54', 'Debelle', 'Michel', 'mdebelle', 'od5rt', '181 avenue Barbusse', '93210', 'Rosny', '2011-11-23'),
('d13', 'Debelle', 'Jeanne', 'jdebelle', 'nvwqq', '134 allée des Joncs', '44000', 'Nantes', '2010-05-11'),
('d51', 'Debroise', 'Michel', 'mdebroise', 'sghkb', '2 Bld Jourdain', '44000', 'Nantes', '2007-04-17'),
('e22', 'Desmarquest', 'Nathalie', 'ndesmarquest', 'f1fob', '14 Place d Arc', '45000', 'Orléans', '2011-11-12'),
('e24', 'Desnost', 'Pierre', 'pdesnost', '4k2o5', '16 avenue des Cèdres', '23200', 'Guéret', '2009-02-05'),
('e39', 'Dudouit', 'Frédéric', 'fdudouit', '44im8', '18 rue de l église', '23120', 'GrandBourg', '2016-08-01'),
('e49', 'Duncombe', 'Claude', 'cduncombe', 'qf77j', '19 rue de la tour', '23100', 'La souteraine', '2020-10-10'),
('e5', 'Enault-Pascreau', 'Céline', 'cenault', 'y2qdu', '25 place de la gare', '23200', 'Gueret', '2021-09-01'),
('e52', 'Eynde', 'Valérie', 'veynde', 'i7sn3', '3 Grand Place', '13015', 'Marseille', '2023-11-01'),
('f21', 'Finck', 'Jacques', 'jfinck', 'mpb3t', '10 avenue du Prado', '13002', 'Marseille', '2009-11-10'),
('f39', 'Frémont', 'Fernande', 'ffremont', 'xs5tq', '4 route de la mer', '13012', 'Allauh', '2015-10-01'),
('f4', 'Gest', 'Alain', 'agest', 'dywvt', '30 avenue de la mer', '13025', 'Berre', '2020-11-01');
...
-- Contenu Rapport
insert into rapport values(NULL,'2024-09-02','Installation nouvelle','Trop pressé','b16',963);
insert into rapport values(NULL ,'2024-09-02','Demande du médecin','Très aimable maintenir un contact régulier','a93',4);
insert into rapport values(NULL,'2024-09-02','Demande du médecin','Trop pressé','a93',86);
insert into rapport values(NULL,'2024-09-02','Recommandation de confrère','Visite positive','a131',2);
insert into rapport values(NULL,'2024-09-02','Recommandation de confrère','Pas intéressé du tout','e49',570);
insert into rapport values(NULL,'2024-09-02','Installation nouvelle','Sur sa réserve','b13',82);
insert into rapport values(NULL,'2024-09-02','Visite annuelle','Pas intéressé du tout','b25',521);
insert into rapport values(NULL,'2024-09-02','Prise de contact','Très fixé sur les produits utilisés','d13',639);
insert into rapport values(NULL,'2024-09-02','Demande du médecin','Visite positive','b16',863);
insert into rapport values(NULL,'2024-09-02','Demande du médecin','A revoir assez rapidement','e39',475);
insert into rapport values(NULL,'2024-09-02','recommandation de confrère','Très aimable maintenir un contact régulier','e39',575);
insert into rapport values(NULL,'2024-09-02','Installation nouvelle','A revoir assez rapidement','b19',268);
insert into rapport values(NULL,'2024-09-02','Installation nouvelle','Demande à me revoir dans un mois','c14',754);
insert into rapport values(NULL,'2024-09-02','Recommandation de confrère','Très aimable maintenir un contact régulier','b50',421);
insert into rapport values(NULL,'2024-09-02','Prise de contact','Sur sa réserve','e5',11);
insert into rapport values(NULL,'2024-09-02','Visite annuelle','Pas très aimable','b59',791);
insert into rapport values(NULL,'2024-09-02','Visite annuelle','Très fixé sur les produits utilisés','e5',28);
insert into rapport values(NULL,'2024-09-02','Installation nouvelle','Sur sa réserve','c14',662);
insert into rapport values(NULL,'2024-09-02','Prise de contact','Très aimable maintenir un contact régulier','e24',365);
insert into rapport values(NULL,'2024-09-02','Demande du médecin','Pas très aimable','b28',882);
insert into rapport values(NULL,'2024-09-03','Visite annuelle','RAS','e39',727);
insert into rapport values(NULL,'2024-09-03','Recommandation de confrère','Visite positive','e39',882);
insert into rapport values(NULL,'2024-09-03','Demande du médecin','Demande à me revoir dans un mois','b34',69);
insert into rapport values(NULL,'2024-09-03','Demande du médecin','Demande à me revoir dans un mois','b4',200);
insert into rapport values(NULL,'2024-09-03','Recommandation de confrère','RAS','c3',265);
insert into rapport values(NULL,'2024-09-03','Demande du médecin','A revoir assez rapidement','d13',589);
insert into rapport values(NULL,'2024-09-03','Demande du médecin','Visite positive','b25',471);
insert into rapport values(NULL,'2024-09-03','Prise de contact','Très intéressé par les produits présentés','a131',935);
insert into rapport values(NULL,'2024-09-03','Recommandation de confrère','Peu bavard','f21',41);
insert into rapport values(NULL,'2024-09-03','Recommandation de confrère','Demande à me revoir dans un mois','e39',148);
insert into rapport values(NULL,'2024-09-03','Installation nouvelle','Peu bavard','d13',820);
insert into rapport values(NULL,'2024-09-03','Recommandation de confrère','Très fixé sur les produits utilisés','b28',691);
insert into rapport values(NULL,'2024-09-03','Recommandation de confrère','A beaucoup appécié notre rencontre','c14',381);
insert into rapport values(NULL,'2024-09-03','Visite annuelle','Très intéressé par les produits présentés','c14',818);
insert into rapport values(NULL,'2024-09-03','Demande du médecin','A revoir assez rapidement','b59',153);
insert into rapport values(NULL,'2024-09-03','Prise de contact','Très aimable maintenir un contact régulier','b25',321);
insert into rapport values(NULL,'2024-09-03','Installation nouvelle','Jeune médecin découvrant les visiteurs','b19',352);
insert into rapport values(NULL,'2024-09-03','Recommandation de confrère','Très aimable maintenir un contact régulier','b34',86);
insert into rapport values(NULL,'2024-09-03','Demande du médecin','Jeune médecin découvrant les visiteurs','c54',404);
insert into rapport values(NULL,'2024-09-03','Prise de contact','Visite positive','e39',803);
insert into rapport values(NULL,'2024-09-04','Prise de contact','Pas très aimable','c14',34);
insert into rapport values(NULL,'2024-09-04','Prise de contact','Trop pressé','e52',738);
insert into rapport values(NULL,'2024-09-04','Prise de contact','Sur sa réserve','d51',628);
insert into rapport values(NULL,'2024-09-04','Demande du médecin','Trop pressé','c3',356);
insert into rapport values(NULL,'2024-09-04','Installation nouvelle','Très aimable maintenir un contact régulier','a17',388);
insert into rapport values(NULL,'2024-09-04','Visite annuelle','Peu bavard','e5',590);
insert into rapport values(NULL,'2024-09-04','Visite annuelle','Jeune médecin découvrant les visiteurs','b13',603);
insert into rapport values(NULL,'2024-09-04','Prise de contact','Très intéressé par les produits présentés','b16',551);
insert into rapport values(NULL,'2024-09-04','Prise de contact','Trop pressé','d13',995);
insert into rapport values(NULL,'2024-09-04','Recommandation de confrère','Pas intéressé du tout','e24',115);
insert into rapport values(NULL,'2024-09-04','Prise de contact','A beaucoup appécié notre rencontre','e5',680);
insert into rapport values(NULL,'2024-09-04','Installation nouvelle','Pas en confiance','e39',564);
insert into rapport values(NULL,'2024-09-04','Recommandation de confrère','A revoir assez rapidement','e22',281);
insert into rapport values(NULL,'2024-09-04','Installation nouvelle','Jeune médecin découvrant les visiteurs','c54',542);
insert into rapport values(NULL,'2024-09-04','Installation nouvelle','Peu intéressé','e5',137);
insert into rapport values(NULL,'2024-09-04','Prise de contact','Très aimable maintenir un contact régulier','b19',362);
insert into rapport values(NULL,'2024-09-04','Recommandation de confrère','Très intéressé par les produits présentés','b16',633);
insert into rapport values(NULL,'2024-09-04','Visite annuelle','Pas très aimable','c14',424);
insert into rapport values(NULL,'2024-09-04','Prise de contact','Peu bavard','e52',663);
insert into rapport values(NULL,'2024-09-04','Visite annuelle','A revoir assez rapidement','e5',437);
insert into rapport values(NULL,'2024-09-05','Installation nouvelle','Pas très aimable','e24',264);
insert into rapport values(NULL,'2024-09-05','Demande du médecin','Peu bavard','e39',7);
insert into rapport values(NULL,'2024-09-05','Visite annuelle','Très intéressé par les produits présentés','b25',895);
insert into rapport values(NULL,'2024-09-05','Prise de contact','Pas très aimable','d13',182);
insert into rapport values(NULL,'2024-09-05','Demande du médecin','A beaucoup appécié notre rencontre','e24',594);
insert into rapport values(NULL,'2024-09-05','Prise de contact','Sur sa réserve','c3',285);
insert into rapport values(NULL,'2024-09-05','Installation nouvelle','Pas intéressé du tout','e22',834);
insert into rapport values(NULL,'2024-09-05','Prise de contact','Peu bavard','b50',531);
insert into rapport values(NULL,'2024-09-05','Visite annuelle','Jeune médecin découvrant les visiteurs','b59',873);
insert into rapport values(NULL,'2024-09-05','Prise de contact','Peu bavard','f39',976);
insert into rapport values(NULL,'2024-09-05','Demande du médecin','A revoir assez rapidement','c54',913);
insert into rapport values(NULL,'2024-09-05','Demande du médecin','Trop pressé','a131',931);
insert into rapport values(NULL,'2024-09-05','Demande du médecin','Pas en confiance','b4',571);
insert into rapport values(NULL,'2024-09-05','Prise de contact','Pas intéressé du tout','e52',487);
insert into rapport values(NULL,'2024-09-05','Visite annuelle','Très fixé sur les produits utilisés','c54',78);
insert into rapport values(NULL,'2024-09-05','Demande du médecin','Peu bavard','b59',103);
insert into rapport values(NULL,'2024-09-05','Installation nouvelle','Pas en confiance','e5',991);
insert into rapport values(NULL,'2024-09-05','Visite annuelle','Demande à me revoir dans un mois','d13',290);
insert into rapport values(NULL,'2024-09-05','Prise de contact','Demande à me revoir dans un mois','b19',314);
insert into rapport values(NULL,'2024-09-05','Prise de contact','Trop pressé','f39',43);
insert into rapport values(NULL,'2024-09-06','Demande du médecin','Demande à me revoir dans un mois','c14',797);
insert into rapport values(NULL,'2024-09-06','Prise de contact','Peu intéressé','a55',747);
insert into rapport values(NULL,'2024-09-06','Prise de contact','RAS','e49',97);
insert into rapport values(NULL,'2024-09-06','Prise de contact','Peu intéressé','e24',389);
insert into rapport values(NULL,'2024-09-06','Installation nouvelle','Très fixé sur les produits utilisés','b25',550);
insert into rapport values(NULL,'2024-09-06','Installation nouvelle','RAS','e39',546);
insert into rapport values(NULL,'2024-09-06','Visite annuelle','Très intéressé par les produits présentés','a131',643);
insert into rapport values(NULL,'2024-09-06','Visite annuelle','Pas très aimable','e52',410);
insert into rapport values(NULL,'2024-09-06','Prise de contact','A beaucoup appécié notre rencontre','e39',422);
insert into rapport values(NULL,'2024-09-06','Prise de contact','Pas en confiance','c3',765);
insert into rapport values(NULL,'2024-09-06','Installation nouvelle','Très intéressé par les produits présentés','b59',117);
insert into rapport values(NULL,'2024-09-06','Recommandation de confrère','A beaucoup appécié notre rencontre','e5',638);
insert into rapport values(NULL,'2024-09-06','Visite annuelle','Visite positive','c54',96);
insert into rapport values(NULL,'2024-09-06','Demande du médecin','Très fixé sur les produits utilisés','b19',257);
insert into rapport values(NULL,'2024-09-06','Recommandation de confrère','Peu bavard','e22',465);
insert into rapport values(NULL,'2024-09-06','Recommandation de confrère','Très fixé sur les produits utilisés','e22',907);
insert into rapport values(NULL,'2024-09-06','Visite annuelle','Jeune médecin découvrant les visiteurs','d13',871);
insert into rapport values(NULL,'2024-09-06','Visite annuelle','Très aimable maintenir un contact régulier','f39',15);
insert into rapport values(NULL,'2024-09-06','Recommandation de confrère','A beaucoup appécié notre rencontre','e52',676);
insert into rapport values(NULL,'2024-09-06','Prise de contact','Pas en confiance','c54',569);
insert into rapport values(NULL,'2024-09-07','Demande du médecin','Jeune médecin découvrant les visiteurs','d13',158);
insert into rapport values(NULL,'2024-09-07','Recommandation de confrère','Visite positive','a131',32);
insert into rapport values(NULL,'2024-09-07','Demande du médecin','A beaucoup appécié notre rencontre','b50',434);
insert into rapport values(NULL,'2024-09-07','Recommandation de confrère','Très intéressé par les produits présentés','e52',181);
insert into rapport values(NULL,'2024-09-07','Demande du médecin','Pas très aimable','a131',525);
insert into rapport values(NULL,'2024-09-07','Recommandation de confrère','RAS','c14',687);
insert into rapport values(NULL,'2024-09-07','Recommandation de confrère','Pas très aimable','b13',867);
insert into rapport values(NULL,'2024-09-07','Prise de contact','Pas très aimable','e22',302);
insert into rapport values(NULL,'2024-09-07','Demande du médecin','Sur sa réserve','b19',455);
insert into rapport values(NULL,'2024-09-07','Recommandation de confrère','A beaucoup appécié notre rencontre','e52',278);
insert into rapport values(NULL,'2024-09-07','Demande du médecin','Pas très aimable','c54',572);
insert into rapport values(NULL,'2024-09-07','Recommandation de confrère','A beaucoup appécié notre rencontre','a131',863);
insert into rapport values(NULL,'2024-09-07','Prise de contact','Pas en confiance','b25',959);
insert into rapport values(NULL,'2024-09-07','Installation nouvelle','Très intéressé par les produits présentés','d51',205);
insert into rapport values(NULL,'2024-09-07','Recommandation de confrère','Peu intéressé','b19',413);
insert into rapport values(NULL,'2024-09-07','Installation nouvelle','Sur sa réserve','b59',698);
insert into rapport values(NULL,'2024-09-07','Recommandation de confrère','Sur sa réserve','a17',857);
insert into rapport values(NULL,'2024-09-07','Recommandation de confrère','Très fixé sur les produits utilisés','b28',833);
insert into rapport values(NULL,'2024-09-07','Installation nouvelle','Pas en confiance','a93',308);
insert into rapport values(NULL,'2024-09-07','Prise de contact','Peu bavard','e39',362);
insert into rapport values(NULL,'2024-09-08','Prise de contact','Pas intéressé du tout','b25',803);
insert into rapport values(NULL,'2024-09-08','Demande du médecin','Demande à me revoir dans un mois','d13',291);
insert into rapport values(NULL,'2024-09-08','Prise de contact','RAS','c54',910);
insert into rapport values(NULL,'2024-09-08','Demande du médecin','Très fixé sur les produits utilisés','d13',205);
insert into rapport values(NULL,'2024-09-08','Visite annuelle','Peu intéressé','e24',775);
insert into rapport values(NULL,'2024-09-08','Prise de contact','Sur sa réserve','a17',126);
insert into rapport values(NULL,'2024-09-08','Demande du médecin','Très fixé sur les produits utilisés','b25',926);
insert into rapport values(NULL,'2024-09-08','Recommandation de confrère','Très aimable maintenir un contact régulier','e39',906);
insert into rapport values(NULL,'2024-09-08','Visite annuelle','Peu intéressé','e5',365);
insert into rapport values(NULL,'2024-09-08','Recommandation de confrère','Pas en confiance','b4',62);
insert into rapport values(NULL,'2024-09-08','Prise de contact','Demande à me revoir dans un mois','b4',779);
insert into rapport values(NULL,'2024-09-08','Recommandation de confrère','Jeune médecin découvrant les visiteurs','c14',172);
insert into rapport values(NULL,'2024-09-08','Visite annuelle','Peu bavard','b16',522);
insert into rapport values(NULL,'2024-09-08','Demande du médecin','RAS','e5',403);
insert into rapport values(NULL,'2024-09-08','Demande du médecin','Sur sa réserve','b4',845);
insert into rapport values(NULL,'2024-09-08','Prise de contact','Pas en confiance','b34',104);
insert into rapport values(NULL,'2024-09-08','Demande du médecin','Trop pressé','e24',404);
insert into rapport values(NULL,'2024-09-08','Installation nouvelle','Pas intéressé du tout','b28',397);
insert into rapport values(NULL,'2024-09-08','Prise de contact','Pas en confiance','b25',707);
insert into rapport values(NULL,'2024-09-08','Installation nouvelle','Pas intéressé du tout','b19',959);
insert into rapport values(NULL,'2024-09-09','Recommandation de confrère','Très intéressé par les produits présentés','e39',986);
insert into rapport values(NULL,'2024-09-09','Visite annuelle','Pas intéressé du tout','e22',143);
insert into rapport values(NULL,'2024-09-09','Visite annuelle','Très fixé sur les produits utilisés','a55',735);
insert into rapport values(NULL,'2024-09-09','Demande du médecin','A beaucoup appécié notre rencontre','c54',788);
insert into rapport values(NULL,'2024-09-09','Prise de contact','Pas intéressé du tout','c14',186);
insert into rapport values(NULL,'2024-09-09','Installation nouvelle','Sur sa réserve','c14',871);
insert into rapport values(NULL,'2024-09-09','Installation nouvelle','Visite positive','a131',511);
insert into rapport values(NULL,'2024-09-09','Installation nouvelle','Sur sa réserve','d13',996);
insert into rapport values(NULL,'2024-09-09','Recommandation de confrère','Très fixé sur les produits utilisés','f21',351);
insert into rapport values(NULL,'2024-09-09','Recommandation de confrère','Très aimable maintenir un contact régulier','f21',992);
insert into rapport values(NULL,'2024-09-09','Recommandation de confrère','Pas très aimable','b4',205);
insert into rapport values(NULL,'2024-09-09','Visite annuelle','Pas très aimable','a93',936);
insert into rapport values(NULL,'2024-09-09','Visite annuelle','Très fixé sur les produits utilisés','b25',484);
insert into rapport values(NULL,'2024-09-09','Installation nouvelle','Très intéressé par les produits présentés','b25',790);
insert into rapport values(NULL,'2024-09-09','Prise de contact','Peu intéressé','b34',328);
insert into rapport values(NULL,'2024-09-09','Demande du médecin','A revoir assez rapidement','b4',834);
insert into rapport values(NULL,'2024-09-09','Recommandation de confrère','Très intéressé par les produits présentés','e49',826);
insert into rapport values(NULL,'2024-09-09','Installation nouvelle','A revoir assez rapidement','e5',41);
insert into rapport values(NULL,'2024-09-09','Demande du médecin','A beaucoup appécié notre rencontre','b16',52);
insert into rapport values(NULL,'2024-09-09','Installation nouvelle','Très aimable maintenir un contact régulier','e22',52);
insert into rapport values(NULL,'2024-09-10','Installation nouvelle','Très intéressé par les produits présentés','b4',237);
insert into rapport values(NULL,'2024-09-10','Recommandation de confrère','Sur sa réserve','b19',829);
insert into rapport values(NULL,'2024-09-10','Visite annuelle','Sur sa réserve','e24',973);
insert into rapport values(NULL,'2024-09-10','Visite annuelle','Trop pressé','e24',789);
insert into rapport values(NULL,'2024-09-10','Demande du médecin','A beaucoup appécié notre rencontre','b4',31);
insert into rapport values(NULL,'2024-09-10','Installation nouvelle','Pas intéressé du tout','b25',858);
insert into rapport values(NULL,'2024-09-10','Installation nouvelle','Pas intéressé du tout','a93',210);
insert into rapport values(NULL,'2024-09-10','Recommandation de confrère','A revoir assez rapidement','a17',278);
insert into rapport values(NULL,'2024-09-10','Demande du médecin','Pas intéressé du tout','d13',144);
insert into rapport values(NULL,'2024-09-10','Installation nouvelle','Sur sa réserve','f21',665);
insert into rapport values(NULL,'2024-09-10','Recommandation de confrère','RAS','d51',495);
insert into rapport values(NULL,'2024-09-10','Prise de contact','Peu intéressé','a131',701);
insert into rapport values(NULL,'2024-09-10','Installation nouvelle','Jeune médecin découvrant les visiteurs','e5',180);
insert into rapport values(NULL,'2024-09-10','Recommandation de confrère','Pas en confiance','b25',414);
insert into rapport values(NULL,'2024-09-10','Installation nouvelle','A beaucoup appécié notre rencontre','d13',628);
insert into rapport values(NULL,'2024-09-10','Recommandation de confrère','RAS','f39',925);
insert into rapport values(NULL,'2024-09-10','Visite annuelle','Très fixé sur les produits utilisés','e39',711);
insert into rapport values(NULL,'2024-09-10','Visite annuelle','Pas très aimable','a131',22);
insert into rapport values(NULL,'2024-09-10','Installation nouvelle','Pas en confiance','b13',738);
insert into rapport values(NULL,'2024-09-10','Installation nouvelle','Demande à me revoir dans un mois','b34',696);
insert into rapport values(NULL,'2024-09-11','Demande du médecin','Très fixé sur les produits utilisés','b50',452);
insert into rapport values(NULL,'2024-09-11','Demande du médecin','Visite positive','b34',506);
insert into rapport values(NULL,'2024-09-11','Recommandation de confrère','A revoir assez rapidement','b34',228);
insert into rapport values(NULL,'2024-09-11','Prise de contact','Très aimable maintenir un contact régulier','d51',806);
insert into rapport values(NULL,'2024-09-11','Visite annuelle','Pas en confiance','b4',9);
insert into rapport values(NULL,'2024-09-11','Visite annuelle','Très aimable maintenir un contact régulier','e22',159);
insert into rapport values(NULL,'2024-09-11','Prise de contact','Visite positive','c3',202);
insert into rapport values(NULL,'2024-09-11','Prise de contact','Pas très aimable','e39',974);
insert into rapport values(NULL,'2024-09-11','Visite annuelle','Peu intéressé','b4',543);
insert into rapport values(NULL,'2024-09-11','Installation nouvelle','A beaucoup appécié notre rencontre','c14',208);
insert into rapport values(NULL,'2024-09-11','Visite annuelle','Pas intéressé du tout','e22',793);
insert into rapport values(NULL,'2024-09-11','Demande du médecin','Demande à me revoir dans un mois','b59',281);
insert into rapport values(NULL,'2024-09-11','Visite annuelle','Très aimable maintenir un contact régulier','e22',892);
insert into rapport values(NULL,'2024-09-11','Demande du médecin','Très aimable maintenir un contact régulier','c3',917);
insert into rapport values(NULL,'2024-09-11','Installation nouvelle','Pas intéressé du tout','a17',561);
insert into rapport values(NULL,'2024-09-11','Demande du médecin','Sur sa réserve','f39',428);
insert into rapport values(NULL,'2024-09-11','Prise de contact','Jeune médecin découvrant les visiteurs','a17',618);
insert into rapport values(NULL,'2024-09-11','Recommandation de confrère','Sur sa réserve','b16',531);
insert into rapport values(NULL,'2024-09-11','Visite annuelle','A revoir assez rapidement','e5',874);
insert into rapport values(NULL,'2024-09-11','Prise de contact','Peu intéressé','e52',625);
insert into rapport values(NULL,'2024-09-12','Demande du médecin','Pas intéressé du tout','a93',153);
insert into rapport values(NULL,'2024-09-12','Recommandation de confrère','Peu intéressé','c3',816);
insert into rapport values(NULL,'2024-09-12','Demande du médecin','Très fixé sur les produits utilisés','e39',330);
insert into rapport values(NULL,'2024-09-12','Prise de contact','Peu bavard','e52',978);
insert into rapport values(NULL,'2024-09-12','Demande du médecin','Pas intéressé du tout','b34',871);
insert into rapport values(NULL,'2024-09-12','Installation nouvelle','Visite positive','b34',928);
insert into rapport values(NULL,'2024-09-12','Visite annuelle','Sur sa réserve','e22',192);
insert into rapport values(NULL,'2024-09-12','Prise de contact','Trop pressé','b28',851);
insert into rapport values(NULL,'2024-09-12','Demande du médecin','Jeune médecin découvrant les visiteurs','b16',4);
insert into rapport values(NULL,'2024-09-12','Visite annuelle','Visite positive','c3',532);
insert into rapport values(NULL,'2024-09-12','Recommandation de confrère','A revoir assez rapidement','b19',445);
insert into rapport values(NULL,'2024-09-12','Demande du médecin','Visite positive','a17',223);
insert into rapport values(NULL,'2024-09-12','Demande du médecin','Peu intéressé','c54',312);
insert into rapport values(NULL,'2024-09-12','Prise de contact','RAS','e52',503);
insert into rapport values(NULL,'2024-09-12','Recommandation de confrère','A revoir assez rapidement','f39',709);
insert into rapport values(NULL,'2024-09-12','Visite annuelle','Jeune médecin découvrant les visiteurs','b28',693);
insert into rapport values(NULL,'2024-09-12','Visite annuelle','Peu intéressé','f21',47);
insert into rapport values(NULL,'2024-09-12','Installation nouvelle','Peu intéressé','f39',451);
insert into rapport values(NULL,'2024-09-12','Installation nouvelle','Visite positive','a17',502);
insert into rapport values(NULL,'2024-09-12','Installation nouvelle','Peu intéressé','c54',305);
insert into rapport values(NULL,'2024-09-13','Visite annuelle','Très fixé sur les produits utilisés','e52',581);
insert into rapport values(NULL,'2024-09-13','Visite annuelle','RAS','b28',346);
insert into rapport values(NULL,'2024-09-13','Prise de contact','Pas en confiance','a17',786);
insert into rapport values(NULL,'2024-09-13','Recommandation de confrère','Visite positive','b28',422);
insert into rapport values(NULL,'2024-09-13','Recommandation de confrère','A beaucoup appécié notre rencontre','b25',402);
insert into rapport values(NULL,'2024-09-13','Recommandation de confrère','RAS','b50',391);
insert into rapport values(NULL,'2024-09-13','Recommandation de confrère','Sur sa réserve','c54',699);
insert into rapport values(NULL,'2024-09-13','Recommandation de confrère','Jeune médecin découvrant les visiteurs','e52',31);
insert into rapport values(NULL,'2024-09-13','Installation nouvelle','Trop pressé','c54',728);
insert into rapport values(NULL,'2024-09-13','Prise de contact','Demande à me revoir dans un mois','c54',155);
insert into rapport values(NULL,'2024-09-13','Installation nouvelle','Pas très aimable','c14',71);
insert into rapport values(NULL,'2024-09-13','Recommandation de confrère','A revoir assez rapidement','c54',887);
insert into rapport values(NULL,'2024-09-13','Prise de contact','Trop pressé','c54',63);
insert into rapport values(NULL,'2024-09-13','Installation nouvelle','A revoir assez rapidement','b4',83);
insert into rapport values(NULL,'2024-09-13','Visite annuelle','A beaucoup appécié notre rencontre','d13',946);
insert into rapport values(NULL,'2024-09-13','Prise de contact','Pas très aimable','b34',139);
insert into rapport values(NULL,'2024-09-13','Recommandation de confrère','RAS','b13',174);
insert into rapport values(NULL,'2024-09-13','Demande du médecin','Pas très aimable','f21',148);
insert into rapport values(NULL,'2024-09-13','Recommandation de confrère','Sur sa réserve','e39',308);
insert into rapport values(NULL,'2024-09-13','Prise de contact','Jeune médecin découvrant les visiteurs','c3',740);
insert into rapport values(NULL,'2024-09-14','Prise de contact','Pas en confiance','b16',323);
insert into rapport values(NULL,'2024-09-14','Installation nouvelle','Visite positive','b4',440);
insert into rapport values(NULL,'2024-09-14','Demande du médecin','A beaucoup appécié notre rencontre','e22',986);
insert into rapport values(NULL,'2024-09-14','Visite annuelle','Trop pressé','e22',6);
insert into rapport values(NULL,'2024-09-14','Demande du médecin','Jeune médecin découvrant les visiteurs','b19',809);
insert into rapport values(NULL,'2024-09-14','Visite annuelle','Jeune médecin découvrant les visiteurs','d13',896);
insert into rapport values(NULL,'2024-09-14','Installation nouvelle','Très fixé sur les produits utilisés','a93',499);
insert into rapport values(NULL,'2024-09-14','Prise de contact','Très intéressé par les produits présentés','c54',639);
insert into rapport values(NULL,'2024-09-14','Recommandation de confrère','Peu intéressé','b4',737);
insert into rapport values(NULL,'2024-09-14','Prise de contact','RAS','b34',979);
insert into rapport values(NULL,'2024-09-14','Installation nouvelle','Pas en confiance','e52',709);
insert into rapport values(NULL,'2024-09-14','Recommandation de confrère','Peu bavard','a17',290);
insert into rapport values(NULL,'2024-09-14','Prise de contact','Demande à me revoir dans un mois','a55',121);
insert into rapport values(NULL,'2024-09-14','Visite annuelle','Pas en confiance','e22',116);
insert into rapport values(NULL,'2024-09-14','Visite annuelle','Pas intéressé du tout','c54',331);
insert into rapport values(NULL,'2024-09-14','Installation nouvelle','Peu intéressé','a131',204);
insert into rapport values(NULL,'2024-09-14','Recommandation de confrère','Très intéressé par les produits présentés','a131',187);
insert into rapport values(NULL,'2024-09-14','Demande du médecin','Peu bavard','c54',172);
insert into rapport values(NULL,'2024-09-14','Visite annuelle','Pas intéressé du tout','b13',311);
insert into rapport values(NULL,'2024-09-14','Prise de contact','Peu bavard','f39',766);
insert into rapport values(NULL,'2024-09-15','Prise de contact','Visite positive','a55',634);
insert into rapport values(NULL,'2024-09-15','Visite annuelle','Très fixé sur les produits utilisés','c14',216);
insert into rapport values(NULL,'2024-09-15','Demande du médecin','Pas intéressé du tout','e22',119);
insert into rapport values(NULL,'2024-09-15','Prise de contact','RAS','b19',725);
insert into rapport values(NULL,'2024-09-15','Installation nouvelle','Trop pressé','e24',827);
insert into rapport values(NULL,'2024-09-15','Recommandation de confrère','Visite positive','a131',412);
insert into rapport values(NULL,'2024-09-15','Visite annuelle','Peu intéressé','a55',837);
insert into rapport values(NULL,'2024-09-15','Prise de contact','Jeune médecin découvrant les visiteurs','c3',97);
insert into rapport values(NULL,'2024-09-15','Demande du médecin','Visite positive','f21',885);
insert into rapport values(NULL,'2024-09-15','Recommandation de confrère','Jeune médecin découvrant les visiteurs','b16',484);
insert into rapport values(NULL,'2024-09-15','Prise de contact','Visite positive','f39',962);
insert into rapport values(NULL,'2024-09-15','Demande du médecin','Très fixé sur les produits utilisés','e22',9);
insert into rapport values(NULL,'2024-09-15','Visite annuelle','Très fixé sur les produits utilisés','d13',855);
insert into rapport values(NULL,'2024-09-15','Visite annuelle','Sur sa réserve','e5',545);
insert into rapport values(NULL,'2024-09-15','Installation nouvelle','Trop pressé','b50',94);
insert into rapport values(NULL,'2024-09-15','Demande du médecin','Trop pressé','d51',802);
insert into rapport values(NULL,'2024-09-15','Installation nouvelle','Pas très aimable','e49',598);
insert into rapport values(NULL,'2024-09-15','Visite annuelle','Jeune médecin découvrant les visiteurs','e52',291);
insert into rapport values(NULL,'2024-09-15','Prise de contact','Pas intéressé du tout','b25',97);
insert into rapport values(NULL,'2024-09-15','Recommandation de confrère','Très intéressé par les produits présentés','a93',718);
insert into rapport values(NULL,'2024-09-16','Visite annuelle','Très intéressé par les produits présentés','e49',103);
insert into rapport values(NULL,'2024-09-16','Installation nouvelle','Pas en confiance','e52',128);
insert into rapport values(NULL,'2024-09-16','Recommandation de confrère','Jeune médecin découvrant les visiteurs','a55',123);
insert into rapport values(NULL,'2024-09-16','Recommandation de confrère','Très intéressé par les produits présentés','a55',866);
insert into rapport values(NULL,'2024-09-16','Visite annuelle','Sur sa réserve','b19',691);
insert into rapport values(NULL,'2024-09-16','Installation nouvelle','Sur sa réserve','e52',632);
insert into rapport values(NULL,'2024-09-16','Prise de contact','Très aimable maintenir un contact régulier','b34',896);
insert into rapport values(NULL,'2024-09-16','Recommandation de confrère','Demande à me revoir dans un mois','d51',714);
insert into rapport values(NULL,'2024-09-16','Prise de contact','Pas en confiance','e52',284);
insert into rapport values(NULL,'2024-09-16','Recommandation de confrère','A beaucoup appécié notre rencontre','a131',993);
insert into rapport values(NULL,'2024-09-16','Installation nouvelle','Pas en confiance','c54',717);
insert into rapport values(NULL,'2024-09-16','Demande du médecin','Demande à me revoir dans un mois','b28',375);
insert into rapport values(NULL,'2024-09-16','Visite annuelle','Jeune médecin découvrant les visiteurs','f21',697);
insert into rapport values(NULL,'2024-09-16','Recommandation de confrère','Jeune médecin découvrant les visiteurs','a17',53);
insert into rapport values(NULL,'2024-09-16','Visite annuelle','A revoir assez rapidement','c3',446);
insert into rapport values(NULL,'2024-09-16','Demande du médecin','RAS','b19',236);
insert into rapport values(NULL,'2024-09-16','Installation nouvelle','Jeune médecin découvrant les visiteurs','c3',222);
insert into rapport values(NULL,'2024-09-16','Visite annuelle','Visite positive','a131',604);
insert into rapport values(NULL,'2024-09-16','Visite annuelle','Pas intéressé du tout','a131',959);
insert into rapport values(NULL,'2024-09-16','Prise de contact','A revoir assez rapidement','b28',743);
insert into rapport values(NULL,'2024-09-17','Recommandation de confrère','Peu bavard','e22',483);
insert into rapport values(NULL,'2024-09-17','Recommandation de confrère','Peu bavard','e52',135);
insert into rapport values(NULL,'2024-09-17','Installation nouvelle','Visite positive','a55',670);
insert into rapport values(NULL,'2024-09-17','Recommandation de confrère','Pas très aimable','d13',659);
insert into rapport values(NULL,'2024-09-17','Prise de contact','Très aimable maintenir un contact régulier','a131',905);
insert into rapport values(NULL,'2024-09-17','Demande du médecin','Très intéressé par les produits présentés','b13',334);
insert into rapport values(NULL,'2024-09-17','Prise de contact','Très aimable maintenir un contact régulier','c3',570);
insert into rapport values(NULL,'2024-09-17','Prise de contact','Très intéressé par les produits présentés','c14',978);
insert into rapport values(NULL,'2024-09-17','Recommandation de confrère','Visite positive','b50',349);
insert into rapport values(NULL,'2024-09-17','Demande du médecin','Pas en confiance','b4',742);
insert into rapport values(NULL,'2024-09-17','Prise de contact','Jeune médecin découvrant les visiteurs','c3',334);
insert into rapport values(NULL,'2024-09-17','Installation nouvelle','Très aimable maintenir un contact régulier','c54',577);
insert into rapport values(NULL,'2024-09-17','Installation nouvelle','Très aimable maintenir un contact régulier','c14',154);
insert into rapport values(NULL,'2024-09-17','Visite annuelle','Très fixé sur les produits utilisés','c14',871);
insert into rapport values(NULL,'2024-09-17','Recommandation de confrère','Jeune médecin découvrant les visiteurs','a55',486);
insert into rapport values(NULL,'2024-09-17','Prise de contact','Très aimable maintenir un contact régulier','e22',551);
insert into rapport values(NULL,'2024-09-17','Demande du médecin','Sur sa réserve','e49',169);
insert into rapport values(NULL,'2024-09-17','Visite annuelle','Pas intéressé du tout','b34',707);
insert into rapport values(NULL,'2024-09-17','Recommandation de confrère','Pas intéressé du tout','b4',814);
insert into rapport values(NULL,'2024-09-17','Prise de contact','Visite positive','c54',69);
insert into rapport values(NULL,'2024-09-18','Installation nouvelle','Peu bavard','f21',71);
insert into rapport values(NULL,'2024-09-18','Installation nouvelle','Jeune médecin découvrant les visiteurs','e39',404);
insert into rapport values(NULL,'2024-09-18','Demande du médecin','Pas très aimable','c14',895);
insert into rapport values(NULL,'2024-09-18','Installation nouvelle','Peu intéressé','b28',175);
insert into rapport values(NULL,'2024-09-18','Installation nouvelle','RAS','a131',588);
insert into rapport values(NULL,'2024-09-18','Prise de contact','Très fixé sur les produits utilisés','b50',314);
insert into rapport values(NULL,'2024-09-18','Recommandation de confrère','Demande à me revoir dans un mois','b16',926);
insert into rapport values(NULL,'2024-09-18','Visite annuelle','Pas en confiance','b28',970);
insert into rapport values(NULL,'2024-09-18','Installation nouvelle','RAS','e24',466);
insert into rapport values(NULL,'2024-09-18','Demande du médecin','Trop pressé','f21',955);
insert into rapport values(NULL,'2024-09-18','Demande du médecin','Jeune médecin découvrant les visiteurs','e5',541);
insert into rapport values(NULL,'2024-09-18','Installation nouvelle','Très fixé sur les produits utilisés','a131',21);
insert into rapport values(NULL,'2024-09-18','Recommandation de confrère','A revoir assez rapidement','a55',548);
insert into rapport values(NULL,'2024-09-18','Recommandation de confrère','RAS','c3',273);
insert into rapport values(NULL,'2024-09-18','Prise de contact','Trop pressé','a55',812);
insert into rapport values(NULL,'2024-09-18','Visite annuelle','Visite positive','b34',625);
insert into rapport values(NULL,'2024-09-18','Demande du médecin','A beaucoup appécié notre rencontre','a55',662);
insert into rapport values(NULL,'2024-09-18','Visite annuelle','Visite positive','e49',65);
insert into rapport values(NULL,'2024-09-18','Visite annuelle','RAS','b19',91);
insert into rapport values(NULL,'2024-09-18','Prise de contact','Peu intéressé','c3',511);
insert into rapport values(NULL,'2024-09-19','Installation nouvelle','Sur sa réserve','f39',789);
insert into rapport values(NULL,'2024-09-19','Prise de contact','Demande à me revoir dans un mois','a93',756);
insert into rapport values(NULL,'2024-09-19','Prise de contact','Très fixé sur les produits utilisés','f21',711);
insert into rapport values(NULL,'2024-09-19','Prise de contact','Sur sa réserve','e39',481);
insert into rapport values(NULL,'2024-09-19','Visite annuelle','A revoir assez rapidement','b25',203);
insert into rapport values(NULL,'2024-09-19','Demande du médecin','Très aimable maintenir un contact régulier','e5',103);
insert into rapport values(NULL,'2024-09-19','Prise de contact','RAS','b59',796);
insert into rapport values(NULL,'2024-09-19','Installation nouvelle','Très fixé sur les produits utilisés','d51',599);
insert into rapport values(NULL,'2024-09-19','Visite annuelle','Pas très aimable','a17',994);
insert into rapport values(NULL,'2024-09-19','Recommandation de confrère','Pas très aimable','a17',506);
insert into rapport values(NULL,'2024-09-19','Prise de contact','Très aimable maintenir un contact régulier','b16',669);
insert into rapport values(NULL,'2024-09-19','Recommandation de confrère','Très intéressé par les produits présentés','c14',935);
insert into rapport values(NULL,'2024-09-19','Demande du médecin','Demande à me revoir dans un mois','a17',367);
insert into rapport values(NULL,'2024-09-19','Installation nouvelle','Très aimable maintenir un contact régulier','a93',385);
insert into rapport values(NULL,'2024-09-19','Demande du médecin','Visite positive','b34',544);
insert into rapport values(NULL,'2024-09-19','Demande du médecin','Très aimable maintenir un contact régulier','f39',985);
insert into rapport values(NULL,'2024-09-19','Recommandation de confrère','Très aimable maintenir un contact régulier','c54',980);
insert into rapport values(NULL,'2024-09-19','Visite annuelle','Demande à me revoir dans un mois','c54',456);
insert into rapport values(NULL,'2024-09-19','Visite annuelle','Demande à me revoir dans un mois','e24',4);
insert into rapport values(NULL,'2024-09-19','Visite annuelle','Sur sa réserve','b16',318);
insert into rapport values(NULL,'2024-09-20','Prise de contact','A beaucoup appécié notre rencontre','c14',19);
insert into rapport values(NULL,'2024-09-20','Prise de contact','Pas intéressé du tout','f21',751);
insert into rapport values(NULL,'2024-09-20','Prise de contact','Trop pressé','d51',13);
insert into rapport values(NULL,'2024-09-20','Demande du médecin','Très fixé sur les produits utilisés','b16',104);
insert into rapport values(NULL,'2024-09-20','Demande du médecin','A revoir assez rapidement','e5',535);
insert into rapport values(NULL,'2024-09-20','Prise de contact','A beaucoup appécié notre rencontre','e5',479);
insert into rapport values(NULL,'2024-09-20','Visite annuelle','Pas très aimable','b13',876);
insert into rapport values(NULL,'2024-09-20','Prise de contact','Sur sa réserve','b16',137);
insert into rapport values(NULL,'2024-09-20','Installation nouvelle','RAS','a131',736);
insert into rapport values(NULL,'2024-09-20','Recommandation de confrère','Peu bavard','c3',504);
insert into rapport values(NULL,'2024-09-20','Demande du médecin','Visite positive','c3',407);
insert into rapport values(NULL,'2024-09-20','Visite annuelle','Pas très aimable','b19',691);
insert into rapport values(NULL,'2024-09-20','Prise de contact','Trop pressé','d13',938);
insert into rapport values(NULL,'2024-09-20','Demande du médecin','Trop pressé','e49',4);
insert into rapport values(NULL,'2024-09-20','Installation nouvelle','RAS','e5',830);
insert into rapport values(NULL,'2024-09-20','Visite annuelle','Très intéressé par les produits présentés','b13',276);
insert into rapport values(NULL,'2024-09-20','Prise de contact','A beaucoup appécié notre rencontre','b34',173);
insert into rapport values(NULL,'2024-09-20','Prise de contact','Très fixé sur les produits utilisés','b25',424);
insert into rapport values(NULL,'2024-09-20','Installation nouvelle','Très aimable maintenir un contact régulier','a93',628);
insert into rapport values(NULL,'2024-09-20','Recommandation de confrère','Très fixé sur les produits utilisés','b34',587);
insert into rapport values(NULL,'2024-09-21','Demande du médecin','Très fixé sur les produits utilisés','b28',913);
insert into rapport values(NULL,'2024-09-21','Prise de contact','Pas intéressé du tout','e39',985);
insert into rapport values(NULL,'2024-09-21','Demande du médecin','RAS','a17',750);
insert into rapport values(NULL,'2024-09-21','Visite annuelle','Pas en confiance','b34',317);
insert into rapport values(NULL,'2024-09-21','Installation nouvelle','Pas intéressé du tout','f21',584);
insert into rapport values(NULL,'2024-09-21','Demande du médecin','RAS','b16',55);
insert into rapport values(NULL,'2024-09-21','Demande du médecin','A revoir assez rapidement','b25',982);
insert into rapport values(NULL,'2024-09-21','Prise de contact','A revoir assez rapidement','a131',238);
insert into rapport values(NULL,'2024-09-21','Installation nouvelle','Pas intéressé du tout','b59',644);
insert into rapport values(NULL,'2024-09-21','Installation nouvelle','Pas intéressé du tout','e24',168);
insert into rapport values(NULL,'2024-09-21','Installation nouvelle','Très aimable maintenir un contact régulier','f21',476);
insert into rapport values(NULL,'2024-09-21','Prise de contact','A beaucoup appécié notre rencontre','b28',926);
insert into rapport values(NULL,'2024-09-21','Recommandation de confrère','Visite positive','f21',694);
insert into rapport values(NULL,'2024-09-21','Prise de contact','Demande à me revoir dans un mois','b34',294);
insert into rapport values(NULL,'2024-09-21','Demande du médecin','Pas intéressé du tout','c3',329);
insert into rapport values(NULL,'2024-09-21','Visite annuelle','Visite positive','b50',22);
insert into rapport values(NULL,'2024-09-21','Recommandation de confrère','Demande à me revoir dans un mois','a17',843);
insert into rapport values(NULL,'2024-09-21','Demande du médecin','Pas en confiance','c3',428);
insert into rapport values(NULL,'2024-09-21','Prise de contact','Demande à me revoir dans un mois','e5',867);
insert into rapport values(NULL,'2024-09-21','Visite annuelle','Pas en confiance','d13',810);
insert into rapport values(NULL,'2024-09-22','Recommandation de confrère','Très aimable maintenir un contact régulier','a131',720);
insert into rapport values(NULL,'2024-09-22','Demande du médecin','Très aimable maintenir un contact régulier','e24',910);
insert into rapport values(NULL,'2024-09-22','Recommandation de confrère','Sur sa réserve','b34',467);
insert into rapport values(NULL,'2024-09-22','Installation nouvelle','Jeune médecin découvrant les visiteurs','b13',908);
insert into rapport values(NULL,'2024-09-22','Recommandation de confrère','Peu intéressé','b59',629);
insert into rapport values(NULL,'2024-09-22','Prise de contact','Très fixé sur les produits utilisés','d51',253);
insert into rapport values(NULL,'2024-09-22','Demande du médecin','A beaucoup appécié notre rencontre','b13',702);
insert into rapport values(NULL,'2024-09-22','Recommandation de confrère','Très fixé sur les produits utilisés','b13',549);
insert into rapport values(NULL,'2024-09-22','Installation nouvelle','Pas en confiance','b50',651);
insert into rapport values(NULL,'2024-09-22','Recommandation de confrère','Pas en confiance','e24',640);
insert into rapport values(NULL,'2024-09-22','Visite annuelle','Sur sa réserve','f21',80);
insert into rapport values(NULL,'2024-09-22','Demande du médecin','Très intéressé par les produits présentés','e22',108);
insert into rapport values(NULL,'2024-09-22','Installation nouvelle','Peu bavard','f21',179);
insert into rapport values(NULL,'2024-09-22','Demande du médecin','Peu bavard','b28',406);
insert into rapport values(NULL,'2024-09-22','Installation nouvelle','Demande à me revoir dans un mois','b59',749);
insert into rapport values(NULL,'2024-09-22','Visite annuelle','RAS','f39',420);
insert into rapport values(NULL,'2024-09-22','Recommandation de confrère','Visite positive','e39',968);
insert into rapport values(NULL,'2024-09-22','Recommandation de confrère','A beaucoup appécié notre rencontre','a55',192);
insert into rapport values(NULL,'2024-09-22','Visite annuelle','Visite positive','c3',340);
insert into rapport values(NULL,'2024-09-22','Prise de contact','Pas très aimable','e52',146);
insert into rapport values(NULL,'2024-09-23','Installation nouvelle','RAS','a17',978);
insert into rapport values(NULL,'2024-09-23','Prise de contact','RAS','b28',678);
insert into rapport values(NULL,'2024-09-23','Prise de contact','RAS','f39',68);
insert into rapport values(NULL,'2024-09-23','Demande du médecin','RAS','b59',23);
insert into rapport values(NULL,'2024-09-23','Visite annuelle','A beaucoup appécié notre rencontre','a55',549);
insert into rapport values(NULL,'2024-09-23','Demande du médecin','Demande à me revoir dans un mois','a93',115);
insert into rapport values(NULL,'2024-09-23','Recommandation de confrère','Demande à me revoir dans un mois','a131',375);
insert into rapport values(NULL,'2024-09-23','Prise de contact','Peu bavard','e5',100);
insert into rapport values(NULL,'2024-09-23','Recommandation de confrère','Très aimable maintenir un contact régulier','f21',116);
insert into rapport values(NULL,'2024-09-23','Recommandation de confrère','RAS','e5',989);
insert into rapport values(NULL,'2024-09-23','Prise de contact','Très intéressé par les produits présentés','c3',931);
insert into rapport values(NULL,'2024-09-23','Prise de contact','RAS','f21',159);
insert into rapport values(NULL,'2024-09-23','Demande du médecin','A beaucoup appécié notre rencontre','b13',23);
insert into rapport values(NULL,'2024-09-23','Prise de contact','Très aimable maintenir un contact régulier','e49',43);
insert into rapport values(NULL,'2024-09-23','Recommandation de confrère','Peu bavard','a93',783);
insert into rapport values(NULL,'2024-09-23','Recommandation de confrère','Peu bavard','b19',443);
insert into rapport values(NULL,'2024-09-23','Visite annuelle','Visite positive','b16',930);
insert into rapport values(NULL,'2024-09-23','Visite annuelle','Très aimable maintenir un contact régulier','a17',157);
insert into rapport values(NULL,'2024-09-23','Installation nouvelle','Très intéressé par les produits présentés','a17',177);
insert into rapport values(NULL,'2024-09-23','Demande du médecin','A revoir assez rapidement','c3',831);
insert into rapport values(NULL,'2024-09-24','Recommandation de confrère','Visite positive','f39',881);
insert into rapport values(NULL,'2024-09-24','Recommandation de confrère','Visite positive','c54',519);
insert into rapport values(NULL,'2024-09-24','Prise de contact','Peu intéressé','b16',6);
insert into rapport values(NULL,'2024-09-24','Recommandation de confrère','Très intéressé par les produits présentés','f39',556);
insert into rapport values(NULL,'2024-09-24','Recommandation de confrère','Très intéressé par les produits présentés','e24',681);
insert into rapport values(NULL,'2024-09-24','Recommandation de confrère','RAS','a55',39);
insert into rapport values(NULL,'2024-09-24','Prise de contact','RAS','b4',408);
insert into rapport values(NULL,'2024-09-24','Demande du médecin','Trop pressé','e49',719);
insert into rapport values(NULL,'2024-09-24','Demande du médecin','Pas intéressé du tout','f39',148);
insert into rapport values(NULL,'2024-09-24','Recommandation de confrère','Très aimable maintenir un contact régulier','d13',330);
insert into rapport values(NULL,'2024-09-24','Demande du médecin','Pas en confiance','b50',139);
insert into rapport values(NULL,'2024-09-24','Visite annuelle','RAS','b25',538);
insert into rapport values(NULL,'2024-09-24','Visite annuelle','Très fixé sur les produits utilisés','b25',99);
insert into rapport values(NULL,'2024-09-24','Prise de contact','Peu intéressé','a131',815);
insert into rapport values(NULL,'2024-09-24','Installation nouvelle','Peu bavard','b4',784);
insert into rapport values(NULL,'2024-09-24','Prise de contact','A revoir assez rapidement','b16',813);
insert into rapport values(NULL,'2024-09-24','Visite annuelle','Très fixé sur les produits utilisés','c54',590);
insert into rapport values(NULL,'2024-09-24','Visite annuelle','Visite positive','c54',495);
insert into rapport values(NULL,'2024-09-24','Prise de contact','Jeune médecin découvrant les visiteurs','b4',129);
insert into rapport values(NULL,'2024-09-24','Prise de contact','Peu bavard','e5',434);
insert into rapport values(NULL,'2024-09-25','Installation nouvelle','Visite positive','b25',794);
insert into rapport values(NULL,'2024-09-25','Demande du médecin','Pas en confiance','b25',507);
insert into rapport values(NULL,'2024-09-25','Demande du médecin','Sur sa réserve','b4',12);
insert into rapport values(NULL,'2024-09-25','Recommandation de confrère','Visite positive','e5',80);
insert into rapport values(NULL,'2024-09-25','Prise de contact','Trop pressé','a17',685);
insert into rapport values(NULL,'2024-09-25','Prise de contact','Trop pressé','b4',260);
insert into rapport values(NULL,'2024-09-25','Recommandation de confrère','Demande à me revoir dans un mois','d13',18);
insert into rapport values(NULL,'2024-09-25','Prise de contact','Peu intéressé','b19',780);
insert into rapport values(NULL,'2024-09-25','Visite annuelle','Peu bavard','a131',608);
insert into rapport values(NULL,'2024-09-25','Recommandation de confrère','Jeune médecin découvrant les visiteurs','b50',335);
insert into rapport values(NULL,'2024-09-25','Visite annuelle','Très intéressé par les produits présentés','b28',988);
insert into rapport values(NULL,'2024-09-25','Prise de contact','Pas très aimable','c14',610);
insert into rapport values(NULL,'2024-09-25','Prise de contact','Très aimable maintenir un contact régulier','d51',919);
insert into rapport values(NULL,'2024-09-25','Recommandation de confrère','A revoir assez rapidement','f39',63);
insert into rapport values(NULL,'2024-09-25','Prise de contact','RAS','e52',548);
insert into rapport values(NULL,'2024-09-25','Visite annuelle','Pas intéressé du tout','a131',393);
insert into rapport values(NULL,'2024-09-25','Recommandation de confrère','Pas très aimable','f21',16);
insert into rapport values(NULL,'2024-09-25','Recommandation de confrère','Pas intéressé du tout','b16',23);
insert into rapport values(NULL,'2024-09-25','Visite annuelle','Pas en confiance','b59',333);
insert into rapport values(NULL,'2024-09-25','Demande du médecin','Jeune médecin découvrant les visiteurs','e49',309);
insert into rapport values(NULL,'2024-09-26','Demande du médecin','RAS','b50',143);
insert into rapport values(NULL,'2024-09-26','Demande du médecin','Très aimable maintenir un contact régulier','e5',872);
insert into rapport values(NULL,'2024-09-26','Recommandation de confrère','Peu bavard','b13',841);
insert into rapport values(NULL,'2024-09-26','Prise de contact','Peu intéressé','b16',943);
insert into rapport values(NULL,'2024-09-26','Visite annuelle','Peu intéressé','a55',818);
insert into rapport values(NULL,'2024-09-26','Installation nouvelle','A beaucoup appécié notre rencontre','e39',293);
insert into rapport values(NULL,'2024-09-26','Visite annuelle','Trop pressé','e24',176);
insert into rapport values(NULL,'2024-09-26','Installation nouvelle','Trop pressé','d51',31);
insert into rapport values(NULL,'2024-09-26','Demande du médecin','Pas très aimable','b19',85);
insert into rapport values(NULL,'2024-09-26','Installation nouvelle','Peu intéressé','b13',546);
insert into rapport values(NULL,'2024-09-26','Installation nouvelle','Très intéressé par les produits présentés','a17',841);
insert into rapport values(NULL,'2024-09-26','Visite annuelle','Très aimable maintenir un contact régulier','b59',278);
insert into rapport values(NULL,'2024-09-26','Prise de contact','A beaucoup appécié notre rencontre','b19',453);
insert into rapport values(NULL,'2024-09-26','Demande du médecin','RAS','d51',792);
insert into rapport values(NULL,'2024-09-26','Demande du médecin','Sur sa réserve','a131',566);
insert into rapport values(NULL,'2024-09-26','Installation nouvelle','Pas en confiance','b13',305);
insert into rapport values(NULL,'2024-09-26','Demande du médecin','Sur sa réserve','d13',948);
insert into rapport values(NULL,'2024-09-26','Installation nouvelle','Sur sa réserve','a93',184);
insert into rapport values(NULL,'2024-09-26','Installation nouvelle','A beaucoup appécié notre rencontre','a17',571);
insert into rapport values(NULL,'2024-09-26','Prise de contact','Peu bavard','b13',784);
insert into rapport values(NULL,'2024-09-27','Visite annuelle','Très fixé sur les produits utilisés','d51',168);
insert into rapport values(NULL,'2024-09-27','Prise de contact','A revoir assez rapidement','e22',224);
insert into rapport values(NULL,'2024-09-27','Recommandation de confrère','Très fixé sur les produits utilisés','e5',627);
insert into rapport values(NULL,'2024-09-27','Recommandation de confrère','Pas très aimable','f21',45);
insert into rapport values(NULL,'2024-09-27','Recommandation de confrère','Pas en confiance','c3',967);
insert into rapport values(NULL,'2024-09-27','Installation nouvelle','A beaucoup appécié notre rencontre','d13',358);
insert into rapport values(NULL,'2024-09-27','Demande du médecin','Très intéressé par les produits présentés','e22',758);
insert into rapport values(NULL,'2024-09-27','Recommandation de confrère','Très intéressé par les produits présentés','b28',278);
insert into rapport values(NULL,'2024-09-27','Recommandation de confrère','A revoir assez rapidement','b4',147);
insert into rapport values(NULL,'2024-09-27','Visite annuelle','Peu bavard','e52',47);
insert into rapport values(NULL,'2024-09-27','Prise de contact','Jeune médecin découvrant les visiteurs','a131',192);
insert into rapport values(NULL,'2024-09-27','Demande du médecin','A beaucoup appécié notre rencontre','b25',129);
insert into rapport values(NULL,'2024-09-27','Installation nouvelle','RAS','d51',711);
insert into rapport values(NULL,'2024-09-27','Demande du médecin','A revoir assez rapidement','a17',628);
insert into rapport values(NULL,'2024-09-27','Recommandation de confrère','Très aimable maintenir un contact régulier','e39',327);
insert into rapport values(NULL,'2024-09-27','Prise de contact','Peu bavard','b25',831);
insert into rapport values(NULL,'2024-09-27','Visite annuelle','Pas très aimable','d13',664);
insert into rapport values(NULL,'2024-09-27','Demande du médecin','Demande à me revoir dans un mois','a131',914);
insert into rapport values(NULL,'2024-09-27','Recommandation de confrère','A beaucoup appécié notre rencontre','c3',344);
insert into rapport values(NULL,'2024-09-27','Prise de contact','Jeune médecin découvrant les visiteurs','a17',873);
insert into rapport values(NULL,'2024-09-28','Installation nouvelle','Pas très aimable','a93',900);
insert into rapport values(NULL,'2024-09-28','Prise de contact','Trop pressé','e5',752);
insert into rapport values(NULL,'2024-09-28','Visite annuelle','Demande à me revoir dans un mois','b28',708);
insert into rapport values(NULL,'2024-09-28','Demande du médecin','Pas très aimable','c14',459);
insert into rapport values(NULL,'2024-09-28','Visite annuelle','A revoir assez rapidement','a17',709);
insert into rapport values(NULL,'2024-09-28','Recommandation de confrère','Trop pressé','e52',821);
insert into rapport values(NULL,'2024-09-28','Visite annuelle','Pas en confiance','e5',886);
insert into rapport values(NULL,'2024-09-28','Installation nouvelle','Pas en confiance','a55',400);
insert into rapport values(NULL,'2024-09-28','Demande du médecin','Peu intéressé','c3',943);
insert into rapport values(NULL,'2024-09-28','Recommandation de confrère','Jeune médecin découvrant les visiteurs','b4',495);
insert into rapport values(NULL,'2024-09-28','Installation nouvelle','Peu intéressé','b59',437);
insert into rapport values(NULL,'2024-09-28','Prise de contact','Pas intéressé du tout','e22',265);
insert into rapport values(NULL,'2024-09-28','Recommandation de confrère','Très intéressé par les produits présentés','b19',321);
insert into rapport values(NULL,'2024-09-28','Demande du médecin','Très aimable maintenir un contact régulier','a131',142);
insert into rapport values(NULL,'2024-09-28','Installation nouvelle','Très aimable maintenir un contact régulier','e52',684);
insert into rapport values(NULL,'2024-09-28','Installation nouvelle','Peu bavard','a55',471);
insert into rapport values(NULL,'2024-09-28','Installation nouvelle','Peu intéressé','b50',322);
insert into rapport values(NULL,'2024-09-28','Visite annuelle','Pas très aimable','d13',703);
insert into rapport values(NULL,'2024-09-28','Installation nouvelle','Pas très aimable','a131',971);
insert into rapport values(NULL,'2024-09-28','Visite annuelle','Très fixé sur les produits utilisés','b28',700);
insert into rapport values(NULL,'2024-09-29','Visite annuelle','Pas très aimable','e52',580);
insert into rapport values(NULL,'2024-09-29','Prise de contact','Demande à me revoir dans un mois','a131',885);
insert into rapport values(NULL,'2024-09-29','recommandation de confrère','Jeune médecin découvrant les visiteurs','b25',493);
insert into rapport values(NULL,'2024-09-29','Prise de contact','Pas en confiance','e24',699);
insert into rapport values(NULL,'2024-09-29','Recommandation de confrère','RAS','e39',566);
insert into rapport values(NULL,'2024-09-29','Recommandation de confrère','Très aimable maintenir un contact régulier','b19',411);
insert into rapport values(NULL,'2024-09-29','Prise de contact','A beaucoup appécié notre rencontre','c14',790);
insert into rapport values(NULL,'2024-09-29','Demande du médecin','RAS','f39',184);
insert into rapport values(NULL,'2024-09-29','recommandation de confrère','A revoir assez rapidement','d13',152);
insert into rapport values(NULL,'2024-09-29','Visite annuelle','Très fixé sur les produits utilisés','a131',865);
insert into rapport values(NULL,'2024-09-29','Recommandation de confrère','Pas très aimable','b50',619);
insert into rapport values(NULL,'2024-09-29','Demande du médecin','Sur sa réserve','b16',78);
insert into rapport values(NULL,'2024-09-29','Recommandation de confrère','Très aimable maintenir un contact régulier','a93',127);
insert into rapport values(NULL,'2024-09-29','Installation nouvelle','Demande à me revoir dans un mois','e5',682);
insert into rapport values(NULL,'2024-09-29','Demande du médecin','Très fixé sur les produits utilisés','a93',917);
insert into rapport values(NULL,'2024-09-29','Demande du médecin','A revoir assez rapidement','c3',864);
insert into rapport values(NULL,'2024-09-29','Prise de contact','Très intéressé par les produits présentés','c14',316);
insert into rapport values(NULL,'2024-09-29','Visite annuelle','Pas très aimable','c54',320);
insert into rapport values(NULL,'2024-09-29','Visite annuelle','Peu intéressé','d51',274);
insert into rapport values(NULL,'2024-09-29','Recommandation de confrère','Pas très aimable','a55',298);
insert into rapport values(NULL,'2024-09-30','Demande du médecin','Très fixé sur les produits utilisés','f21',33);
insert into rapport values(NULL,'2024-09-30','Recommandation de confrère','Visite positive','b59',205);
insert into rapport values(NULL,'2024-09-30','Demande du médecin','Peu bavard','e39',611);
insert into rapport values(NULL,'2024-09-30','Demande du médecin','Très intéressé par les produits présentés','c54',635);
insert into rapport values(NULL,'2024-09-30','Visite annuelle','A beaucoup appécié notre rencontre','b16',205);
insert into rapport values(NULL,'2024-09-30','Installation nouvelle','Peu intéressé','f39',251);
insert into rapport values(NULL,'2024-09-30','Installation nouvelle','Visite positive','a93',788);
insert into rapport values(NULL,'2024-09-30','Visite annuelle','Pas très aimable','e24',748);
insert into rapport values(NULL,'2024-09-30','Demande du médecin','Visite positive','c3',813);
insert into rapport values(NULL,'2024-09-30','Demande du médecin','A beaucoup appécié notre rencontre','f39',542);
insert into rapport values(NULL,'2024-09-30','Prise de contact','Demande à me revoir dans un mois','e5',867);
